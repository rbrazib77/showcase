          ...
          <div className="brand border-t-[2px] border-b-[2px] border-[#303030] justify-around items-center md:rounded-t-[20%] lg:rounded-t-[20%] xl:rounded-t-[20%] 2xl:rounded-t-[20%] md:rounded-b-[20%] lg:rounded-b-[20%] xl:rounded-b-[20%] 2xl:rounded-b-[20%]  overflow-hidden">
            <div className="brand-slider">
              <Slider {...settings}>
                ...
                <div className="img flex justify-center items-center relative after:absolute after:right-0 after:w-[2px] after:h-[280px] after:contents-[''] after:-top-10 after:bg-[#303030]  p-10 md:p-16">
                  <picture>
                    <img
                      className="w-28 xl:w-auto block m-auto"
                      src={b2}
