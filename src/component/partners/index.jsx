  ...
  return (
    <section className="bg-black pb-[70px]">
      <div className="cus-container">
        ...
        <p className="text-[#C0C0C0] text-center px-[10px] md:px-[130px] lg:px-[130px] xl:px-[130px] 2xl:px-[130px] font-medium font-helvetica pb-10 md:pb-20 lg:pb-20 xl:pb-20 2xl:pb-20 text-sm md:text-2xl lg:text-2xl 2xl:text-2xl w-[400px]  md:w-[1075px] lg:w-[1075px] xl:w-[1075px] 2xl:w-[1075px] leading-[141%]  relative left-[50%] translate-x-[-50%]">
