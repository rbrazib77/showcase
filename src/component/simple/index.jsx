...
const index = () => {
  ...
  return (
    <section className="bg-black pb-[60px] md:pb-[440px] lg:pb-[440px] xl:pb-[440px] 2xl:pb-[440px]">
      <div>
        <div className="">
          <h2 className="text-5xl md:text-6xl lg:text-6xl xl:text-6xl 2xl:text-6xl text-[#FFFFFF] leading-[120%] text-center font-medium pb-[26px] pt-[0px] md:pt-[153px] lg:pt-[153px] xl:pt-[153px] 2xl:pt-[153px]">
            In 3 <span className="text-[#F7381E] italic">Simple</span> Steps
          </h2>
          <p className="text-[18px] px-[30px] text-[#C0C0C0] text-center m-auto max-w-[700px] leading-[138%] font-helvetica font-medium pb-[50px] md:pb-[237px] lg:pb-[237px] xl:pb-[237px] 2xl:pb-[237px]">
        ...
        <div className="md:flex lg:flex xl:flex 2xl:flex justify-between items-center ml-[20px]  md:ml-[150px] lg:ml-[150px] xl:ml-[150px] 2xl:ml-[150px]  mr-[20px] md:mr-[87px] lg:mr-[87px] xl:mr-[87px] 2xl:mr-[87px] duration-300 ease-linear group border-b-[1px] border-[#363636] pb-8">
          <div className="">
            <div className="flex items-center">
              <li className="list-none text-[#B7B7B7] text-4xl md:text-6xl lg:text-6xl xl:text-6xl 2xl:text-6xl pr-[10px] md:pr-[65px] lg:pr-[65px] xl:pr-[65px] 2xl:pr-[65px]">
                01.
              </li>
              <h1 className="text-[#B7B7B7] text-[40px] md:text-[100px] lg:text-[100px] xl:text-[100px] 2xl:text-[100px] italic leading-[120%] font-artusiG pr-[32px] ">
                Renders
              </h1>
              <span>
                <a href="#">
                  <IoIosArrowRoundUp className="inline-block rotate-45 text-4xl text-[#F7381E] group-hover:rotate-[220deg] p-2 border h-[60px] md:h-[70px] lg:h-[70px] xl:h-[70px] 2xl:h-[70px] w-[60px] md:w-[70px] xl:w-[70px] 2xl:w-[70px] border-[#F7381E] rounded-full" />
                </a>
              </span>
            </div>
            <div className="hidden group-hover:block md:pl-[145px] lg:pl-[145px] xl:pl-[145px] 2xl:pl-[145px]">
              <p className="text-[#DBDBDB80] text-[28px] w-[380px] md:w-[677px] lg:w-[677px] xl:w-[677px] 2xl:w-[677px] font-helvetica font-normal leading-[43px] pt-12 pb-[70px]">
