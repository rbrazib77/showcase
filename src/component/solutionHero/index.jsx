          ...
          <div className="cus-container">
            <div className="md:flex justify-between">
              <div className=" md:w-3/5 lg:w-2/5 mt-7 sm:mt-0">
                <div className="box inline-block p-5 sm:p-0  w-[360px] md:w-[880px] lg:w-[880px] xl:w-[880px] 2xl:w-[880px] bg-gradient-to-t to-[#6767675e] via-[#74747433] from-[#ffffff22] xl:py-9 xl:px-[100] rounded-2xl  backdrop-blur-sm border border-[#676767] mt-32 sm:mt-[50%] md:mt-[80%] md:mr-1 lg:mr-0 lg:mt-[85%]">
                  <h4 className="font-helvetica font-medium text-4xl md:text-6xl lg:text-6xl xl:text-6xl 2xl:text-6xl text-white leading-[40px] md:leading-[56px] lg:leading-[56px] xl:leading-[56px] 2xl:leading-[56px]">
                    X marks the spot where your
