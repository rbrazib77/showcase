          ...
          <div className="title pb-10 md:pb-28 lg:pb-28 xl:pb-28 2xl:pb-28">
            <div className="heading text-center">
              <h3 className="font-helvetica capitalize font-medium text-[28px] tracking-[1%] sm:text-6xl leading-[120%] text-white">
                ...
                <br />{" "}
                <span className="font-artusi italic font-thin">conversion</span>{" "}
                rate increase
              </h3>
            </div>
            <p className="font-helvetica font-medium text-[#c0c0c0c5] text-[12px] px-8 sm:text-lg max-w-[382px] md:max-w-[776px] lg:max-w-[776px] xl:max-w-[776px] 2xl:max-w-[776px] m-auto text-center pt-3 md:pt-4 lg:pt-4 xl:pt-4 2xl:pt-5">
              showcase x drives an increase in e-commerce product purchases like
              never before. This is the next generation of online commerce.
            </p>
          </div>
          ...
          <div className="content sm:flex justify-around flex-wrap">
            <div className="md:w-1/2 lg:w-1/3  sm:p-6">
              <div className="box bg-gradient-to-b to-[#45454544] from-[#4545451f] p-5 sm:p-10 border-l border-[#303030] duration-300 ease-linear hover:border-highlight hover:to-[#4545453f] hover:from-[#45454559]">
                ...
                <p className="font-helvetica font-medium text-[#c0c0c0c5] text-base pt-4">
                  showcase X immersive product experience means consumers spend
                  longer discovering products, enjoying the experience,
                  appreciating every intricate detail of a product and
                  understanding brand DNA on a whole new level, all from the
                  context of their own familiar setting.
                </p>
              </div>
            </div>
            <div className="md:w-1/2 lg:w-1/3 sm:p-6  mt-10">
              <div className="box bg-gradient-to-b to-[#45454544] from-[#4545451f] p-5 sm:p-10 border-l border-[#303030]  duration-300 ease-linear hover:border-highlight hover:to-[#4545453f] hover:from-[#45454559]">
                ...
                <p className="font-helvetica font-medium text-[#c0c0c0c5] text-base pt-4">
                  ...
                  comprehensive understanding of the product. This results in
                  far more assured purchasing decisions, ultimately reducing
            ...
            <div className="md:w-1/2 lg:w-1/3 sm:p-6  mt-10 sm:mt-0">
              <div className="box bg-gradient-to-b to-[#45454544] from-[#4545451f] p-5 sm:p-10 border-l border-[#303030]  duration-300 ease-linear hover:border-highlight hover:to-[#4545453f] hover:from-[#45454559]">
                ...
                <p className="font-helvetica font-medium text-[#c0c0c0c5] text-base pt-4">
                  Every product that is connected to a showcase AR display, can
                  be updated, with new experiences for the customer to enjoy.
                  This heightens value in the long run and encourages customers
                  to continue share usger generated content around the product
                  boosting awareness for a brand its products.{" "}
                </p>
              </div>
            </div>
          </div>
...
>>>>>>> origin/main
                    ...
                    spend longer discovering products, enjoying the experience,
                    appreciating every intricate detail of a product and
                    understanding brand DNA on a whole new level, all from the
                    context of their own familiar setting.
                  </p>
