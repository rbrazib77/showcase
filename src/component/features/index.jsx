      ...
      <div>
        <div className="md:flex lg:flex xl:flex 2xl:flex">
          <div className="w-full md:w-1/3 lg:w-1/3 xl:w-1/3 2xl:w-1/3 lg:hover:w-1/2 md:hover:w-1/2 xl:hover:w-1/2 2xl:hover:w-1/2 relative duration-300 ease-linear bg-[#191919] pl-10 md:pl-20 lg:pl-20 xl:pl-20 2xl:pl-20 py-16 mr-7 overflow-hidden group">
            ...
            <p className="font-helvetica text-3xl text-[#878787] pt-[90px] pb-4">
              Product Dispaly
            </p>
            <p className="font-helvetica text-3xl text-[#878787] pb-4">VOT</p>
            <p className="font-helvetica text-3xl text-[#878787] pb-4">
              Real Time Colorways/Co-Cretion
            </p>
            <p className="font-helvetica text-3xl text-[#878787] pb-4">
              Screen Capture And Social Media Share
            </p>
            <p className="font-helvetica text-3xl text-[#878787]">
              On / Off Avatar
            </p>
          </div>
