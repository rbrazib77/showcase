...
const index = () => {
  return (
    <section className="bg-black px-[175px] pt-[153px] pb-[303px]">
      <div className="">
        <p className="w-[1085px] px-11 text-center m-auto text-6xl text-[#FFFFFF] tracking-[1%]  leading-[120%]">
          Our straightforward{" "}
          <span className="text-[#F7381E] italic">pricing structure ensures</span> you
