...
const index = () => {
  return (
    <section className='bg-black'>
        ...
        Co-founded by <a href="" className='underline'>Arman Atoyan</a>, with over with 15 years in AR, and <a href="#" className='underline'>Charles</a> Wilders, digital fashion entrperenur and keynote speaker. Here at Demo day December 2023 - (formerly called OuttaWRLD)
        </p>
        <picture>
